...
VkResult CreateDebugUtilsMessenger(VkInstance instance, VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) {
...
const std::vector<uint16_t> indcies = {
    0, 1, 2, 2, 3, 0,
    4, 5, 6, 6, 7, 4
};
...
private:
    ...
    void drawFrame() {
        ...
        VkSemaphore signaledSemaphores[] = { renderFinishedSemaphores[currentFrame] };
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f), time * 0.25f * glm::radians(90.0f), glm::vec3(0.0f, 0.0, 1.0f));
    ...
    void createIndexBuffer() {
        VkDeviceSize bufferSize = sizeof(indcies[0]) * indcies.size();
        VkBuffer stagingBuffer;
        VkDeviceMemory stagingBufferMemory;
        createBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, stagingBuffer, stagingBufferMemory);
        ...
        void* data;
        vkMapMemory(device, stagingBufferMemory, 0, bufferSize, 0, &data);
        memcpy(data, indcies.data(), (size_t)bufferSize);
        vkUnmapMemory(device, stagingBufferMemory);
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        vkCmdDrawIndexed(commandBuffer, static_cast<uint32_t>(indcies.size()), 1, 0, 0, 0);
    ...
    bool isDeviceSuitable(VkPhysicalDevice physical_device) {
        ...
        bool extensionSupported = checkDeviceExtensionSupport(physical_device);
