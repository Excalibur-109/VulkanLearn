void RHID3D12Backend::destroy(RHIBuffer handle) noexcept {
...
void RHID3D12Backend::destroy(RHITexture handle) noexcept {
...
void RHID3D12Backend::destroy(RHITextureView handle) noexcept {
...
void RHID3D12Backend::destroy(RHISampler handle) noexcept {
...
void RHID3D12Backend::destroy(RHIShader handle) noexcept {
...
void RHID3D12Backend::destroy(RHIBindGroupLayout handle) noexcept {
    if (Impl::BindGroupLayoutResource* resource = getRenderResource(impl_->bindGroupLayouts, handle)) {
        resource->desc = {};
    }
}

void RHID3D12Backend::destroy(RHIBindGroup handle) noexcept {
...
void RHID3D12Backend::destroy(RHIPipelineLayout handle) noexcept {
...
void RHID3D12Backend::destroy(RHIPipelineCache handle) noexcept {
    if (Impl::PipelineCacheResource* resource = getRenderResource(impl_->pipelineCaches, handle)) {
        resource->desc = {};
    }
}

void RHID3D12Backend::destroy(RHIPipeline handle) noexcept {
...
void RHID3D12Backend::destroy(RHIQueryPool handle) noexcept {
...
void RHID3D12Backend::destroy(RHISemaphore handle) noexcept {
...
void RHID3D12Backend::destroy(RHIFence handle) noexcept {
...
void RHID3D12Backend::destroy(RHISwapchain handle) noexcept {
